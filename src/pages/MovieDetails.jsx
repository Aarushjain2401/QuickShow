...
const MovieDetails = ()=>{
  ...
  return show ? (
    ...
    <div className="flex items-center gap-2 text-gray-300"><StarIcon className="w-5 h-5 text-primary fill-primary"/>{show.movie.vote_average.toFixed(1)} User Rating</div>
    ...
    <div className="flex items-center flex-wrap gap-4 mt-4">
      ...
      <button onClick={handleFavoriteMovies} className="bg-gray-700 p-2.5 rounded-full transition cursor-pointer active:scale-95">
    ...
    {show.movie.casts.slice(0,12).map((cast,index)=>(
      ...
      <div className="flex flex-wrap mx-sm:justify-center gap-1">
      </div>
