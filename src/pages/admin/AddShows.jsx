    ...
    return nowPlayingMovies.length > 0 ? (
        <>
                    ...
                    {nowPlayingMovies.map((movie) => (
                        <div key={movie.id} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`} onClick={() => setSelectedMovie(movie.id)}>
                            <div>
                                ...
                                <div className="text-sm flex items-center justify-between p-2 bg-black/70 w-full bottom-0 left-0">
            ...
            <div className="mt-6">
                ...
                <div className="inline-flex items-center gap-2 border border-gray-600 p-1 pl-2 rounded-lg">
                    <input type="datetime-local" value={dateTimeInput} onChange={(e) => setDateTimeInput(e.target.value)} placeholder="Enter Show Price" className="outline-none rounded-md" />
